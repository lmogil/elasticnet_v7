...
main <- function(snp_annot_file, gene_annot_file, genotype_file, expression_file,
  ...
  # Prepare output data----
  model_summary_file <- '/home/lauren/PredictDB_Pipeline_GTEx_v7/new_output/' %&% prefix %&% '_chr' %&% chrom %&% '_model_summaries.txt'
  ...
  weights_file <- '/home/lauren/PredictDB_Pipeline_GTEx_v7/new_output/' %&% prefix %&% '_chr' %&% chrom %&% '_weights.txt'
  weights_col <- c('gene_id', 'rsid', 'varID', 'ref', 'alt', 'beta')
  write(weights_col, file = weights_file, ncol = 6, sep = '\t')
  
  tiss_chr_summ_f <- '/home/lauren/PredictDB_Pipeline_GTEx_v7/new_output/' %&% prefix %&% '_chr' %&% chrom %&% '_tiss_chr_summary.txt'
  ...
  covariance_file <- '/home/lauren/PredictDB_Pipeline_GTEx_v7/new_output/' %&% prefix %&% '_chr' %&% chrom %&% '_covariances.txt'
